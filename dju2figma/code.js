...
function writer(data, par, sel, images, string) {
                ...
                if (data["styles"]) {
                    ...
                    for (let i = 0; i < data["styles"].length; i++) {
                        ...
                        if (data["styles"][i]["family"]) {
                            yield figma.loadFontAsync({ family: data["styles"][i]["family"], style: data["styles"][i]["style"] });
                        ...
                        if (data["styles"][i]["paragraphSpacing"]) {
                            element.paragraphSpacing = data["styles"][i]["paragraphSpacing"];
                        }
                        if (data["styles"][i]["paragraphIndent"]) {
                            //element.paragraphIndent = data["styles"][i]["paragraphIndent"];
                        ...
                        if (data["styles"][i]["textAlignHorizontal"]) {
                            element.textAlignHorizontal = data["styles"][i]["textAllignHorizontal"];
                        }
                        /*
...
figma.ui.onmessage = (msg) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (msg.type === 'send-data') {
        ...
        yield writer(data, figma.root, false, images, "base");
    }
